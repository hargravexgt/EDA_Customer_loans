...
loan_payments[datestring_cols].head()
...
transformer_1.drop_column(numeric_df, 'collection_recovery_fee')
transformer_1.drop_column(numeric_df, 'instalment')
# %% Plotting corr matrix again
px.imshow(numeric_df.corr(), title="Correlation heatmap of student dataframe")
# %% One more
transformer_1.drop_column(numeric_df, 'collection_recovery_fee')
